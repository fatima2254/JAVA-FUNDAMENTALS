...
//        System.out.println(Arrays.deepToString(nestedArray));
    ...
    public void testLoopOverNestedArray() {
        ...
        String result1 = nestedArray[0][0]+" "+nestedArray[0][1]+" "+nestedArray[0][2]+" "+nestedArray[0][3]
                +" "+nestedArray[1][0]+" "+nestedArray[1][1]+" "+nestedArray[1][2]+" "+nestedArray[1][3];
        Assert.assertEquals(result1, "John Mary Alice Bob Volvo BMW Ford Mazda");

        String result2 = nestedArray[0][0]+" "+nestedArray[1][0]+" "+nestedArray[0][1]+" "+nestedArray[1][1]
                +" "+nestedArray[0][2]+" "+nestedArray[1][2]+" "+nestedArray[0][3]+" "+nestedArray[1][3];
        Assert.assertEquals(result2, "John Volvo Mary BMW Alice Ford Bob Mazda");

        String result3 = nestedArray[0][0]+" "+nestedArray[1][3]+" "+nestedArray[0][1]+" "+nestedArray[1][2]
                +" "+nestedArray[0][2]+" "+nestedArray[1][1]+" "+nestedArray[0][3]+" "+nestedArray[1][0];
